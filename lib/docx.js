...
export function buildDocx({ name = '简历', theme = {}, data = {} }) {
  ...
  const keep = mask ? ['intent', 'city', 'phone', 'email', 'years'] : ['intent', 'city', 'phone', 'email', 'birth', 'nation', 'polity', 'home', 'build', 'years', 'salary', 'available', 'license'];
  const rawVals = { intent: b.intent, city: b.city, phone: b.phone, email: b.email, birth: b.birth, nation: b.nation, polity: b.polity, home: b.home, build: b.build, years: b.years ? `${b.years} 年经验` : '', salary: b.salary, available: b.available, license: b.license };
